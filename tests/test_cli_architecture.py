...
class CliArchitectureTests(unittest.TestCase):
    ...
    def test_build_parser_registers_nested_aliases(self) -> None:
        ...
        self.assertEqual(["validate", "dashboard", "inspect-proposals"], list(data_choices))
        self.assertEqual(["init", "validate", "dashboard", "inspect-proposals"], list(library_choices))
