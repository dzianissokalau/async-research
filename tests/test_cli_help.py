...
class CliHelpTests(unittest.TestCase):
    ...
    def test_every_public_command_help_has_operator_context(self) -> None:
        cases = [
            ...
            (["workflow"], ["schema", "readiness", "review aggregation", "accepted-memory", "surface", "health", "check", "status", "next", "worker-start", "worker-complete", "advance"]),
            ...
            (["prompts", "init"], ["prompt files", "versions.json", "history.jsonl", "--force"]),
