...
class CliHelpTests(unittest.TestCase):
    ...
    def test_every_public_command_help_has_operator_context(self) -> None:
        cases = [
            ...
            (["idea"], ["idea-evaluation JSON artifacts", "score", "validate", "capture", "catalog"]),
            (["idea", "capture"], ["discovery_inbox.md", "--from-inbox", "--title", "dry-run only"]),
            (["idea", "catalog"], ["durable idea catalog", "init", "validate", "list", "show", "maintain", "discovery_inbox.md", "queue.md"]),
            ...
            (["idea", "catalog", "maintain"], ["discovery_inbox.md", "dry-run", "never edits queue.md"]),
    ...
    def test_readme_documents_exit_code_contract(self) -> None:
        ...
        for snippet in [
            ...
            "| `idea capture` and `idea catalog maintain` | `0` dry-run proposal printed.",
