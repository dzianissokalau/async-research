    ...
    def test_planner_prompt_uses_catalog_promotion_write_mode(self) -> None:
        self.assert_doc_contains(
            ...
            [
                ...
                "`missing_library_support` means unresolved `library_refs` need resolved `LIT-*` support",
    ...
    def test_core_docs_explain_discovery_catalog_queue_flow(self) -> None:
        self.assert_doc_contains(
            ...
            [
                ...
                "`missing_library_support` means `library_refs` did not resolve against `research_ops/library/source_library.md`",
        ...
        self.assert_doc_contains(
            ...
            [
                ...
                "missing library support -> resolve `library_refs` in `source_library.md` or run `literature_extract` before library-dependent routes",
