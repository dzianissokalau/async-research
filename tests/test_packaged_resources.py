...
class PackagedResourceTests(unittest.TestCase):
    ...
    def test_key_resources_are_available_via_importlib_resources(self) -> None:
        ...
        required = [
            ...
            ("schemas", "runtime_eval_suite.schema.json"),
            ("schemas", "runtime_eval_run.schema.json"),
            ("schemas", "research_brief.schema.json"),
            ("schemas", "model_routing_policy.schema.json"),
            ("schemas", "evidence_memory_index.schema.json"),
            ("schemas", "targeted_reflection.schema.json"),
            ("schemas", "interaction_mode.schema.json"),
            ...
            ("templates", "generic_research_ops_starter", "research_ops", "auto_decisions.md"),
            ("templates", "generic_research_ops_starter", "research_ops", "interaction_mode.json"),
            ...
            ("templates", "generic_research_ops_starter", "research_ops", "evals", "README.md"),
            ("templates", "generic_research_ops_starter", "research_ops", "evals", "runs", ".gitkeep"),
            ("templates", "generic_research_ops_starter", "research_ops", "tasks", ".gitkeep"),
            ("templates", "research_ops_starter", "research_ops", "README.md"),
            ("templates", "research_ops_starter", "research_ops", "auto_decisions.md"),
            ("templates", "research_ops_starter", "research_ops", "interaction_mode.json"),
            ...
            ("templates", "research_ops_starter", "research_ops", "evals", "README.md"),
            ("templates", "research_ops_starter", "research_ops", "evals", "runs", ".gitkeep"),
