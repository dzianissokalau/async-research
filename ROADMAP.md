...
| 2026-05-04 | P1: Runtime resource canonicalization | Next | De-duplicate schema/resource locations behind one canonical loader. | Choose canonical resource paths, update script loaders, keep drift tests green, and remove or generate duplicate copies only after compatibility is protected. | Not started. |
