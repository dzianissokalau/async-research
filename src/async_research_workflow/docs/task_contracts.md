...
`async_research_workflow/examples/result_summary_template.md`. Predictive
...
python3 async_research_workflow/examples/scripts/validate_transition.py research_ops/tasks/TASK-0001
```
...
```bash
python3 async_research_workflow/examples/scripts/recover_status_json.py research_ops/tasks/TASK-0001
```
...
```bash
python3 async_research_workflow/examples/scripts/revision_counter.py request research_ops/tasks/TASK-0001
```
...
```bash
python3 async_research_workflow/examples/scripts/aggregate_reviews.py research_ops/tasks/TASK-0001
```
