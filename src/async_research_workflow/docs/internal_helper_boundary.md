...
| `foundation_proposals` | Future `async-research data inspect-proposals` and `async-research library inspect-proposals` commands. | Shared read-only proposal parser/validator; operator workflows use target-specific inspection commands. |
