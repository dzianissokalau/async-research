...
| aggregator | deterministic script plus optional narrative model | review_aggregator_v1.0 | review_aggregation_v1.0, result_acceptance_v1.0 | yes | `aggregate_reviews.py` computes route; narrative model may only summarize. |
