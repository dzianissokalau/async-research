...
| [Integrated Research Runtime And Eval Flywheel Roadmap](./in_progress_integrated_research_runtime_eval_flywheel_roadmap.md) | In Progress | Phase 8 - Structured evidence memory and targeted reflection | 2026-05-20 | Add queryable evidence state, contradiction links, failure classes, and targeted critic routing. | None |
