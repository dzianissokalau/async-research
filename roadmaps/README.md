...
| [Interaction Modes And Autonomous Mode Roadmap](./in_progress_interaction_modes_autonomous_mode_roadmap.md) | In Progress | Phase 4 - Workflow Integration | 2026-05-22 | Wire interaction modes into readiness, workflow next/advance, review aggregation, idea catalog, and deliverable gates. | None |
