...
| [Integrated Research Runtime And Eval Flywheel Roadmap](./in_progress_integrated_research_runtime_eval_flywheel_roadmap.md) | In Progress | Phase 6 - GPT-5.5-era prompt and model routing | 2026-05-20 | Modernize prompt and model routing policy against eval comparisons. | None |
