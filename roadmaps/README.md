...
| [Integrated Research Runtime And Eval Flywheel Roadmap](./in_progress_integrated_research_runtime_eval_flywheel_roadmap.md) | In Progress | Phase 4 - Claim and citation verification | 2026-05-20 | Extract claims, map them to evidence spans, verify citation provenance, and block or cap unsupported material claims. | None |
