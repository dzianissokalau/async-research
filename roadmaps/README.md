...
| [Post-Review Operator Trust And Workflow Roadmap](./in_progress_post_review_operator_trust_roadmap.md) | In Progress | Phase 0 - Audit correctness and review guardrails | 2026-05-13 | Fix decision-log row/header mismatch, then add review-submit state guards. | None |
