...
| [Integrated Research Runtime And Eval Flywheel Roadmap](./in_progress_integrated_research_runtime_eval_flywheel_roadmap.md) | In Progress | Phase 11 - Optional scalable state backend | 2026-05-20 | Measure scaling friction and decide whether optional indexed state is justified. | None |
