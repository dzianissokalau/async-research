...
| [Integrated Research Runtime And Eval Flywheel Roadmap](./in_progress_integrated_research_runtime_eval_flywheel_roadmap.md) | In Progress | Phase 1 - Evidence objects and trace ledger | 2026-05-20 | Add stable runtime evidence and trace schemas, validators, ledgers, CLI summaries, dashboard fields, and offline fixtures. | None |
