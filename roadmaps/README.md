...
| [Hypothesis Testing Framework Roadmap](./in_progress_hypothesis_testing_framework_roadmap.md) | In Progress | Phase 5 ready | 2026-05-09 | Implement Phase 5 analysis validation CLI. | None |
