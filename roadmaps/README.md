...
| [Interaction Modes And Autonomous Mode Roadmap](./in_progress_interaction_modes_autonomous_mode_roadmap.md) | In Progress | Phase 5 - Dashboard And Operator UX | 2026-05-22 | Expose mode, interrupt policy, auto-decisions, and progression-flow effects in the dashboard. | None |
