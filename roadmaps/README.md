...
| [Integrated Research Runtime And Eval Flywheel Roadmap](./in_progress_integrated_research_runtime_eval_flywheel_roadmap.md) | In Progress | Phase 5 - Trace-driven eval flywheel | 2026-05-20 | Build trace-driven eval dataset schema, graders, comparison commands, dashboard metrics, and release policy. | None |
