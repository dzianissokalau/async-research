...
| [Framework Simplification Strategy](./in_progress_framework_simplification_strategy.md) | In Progress | Phase 2 - Init and starter smoke services | 2026-05-25 | Start the transactional init and starter-smoke service extraction. | None |
