...
| [LLM Operator Skill Roadmap](./delivered_llm_operator_skill_roadmap.md) | Delivered | Complete | 2026-05-20 | Final branch push and automation pause. | None |
| [Integrated Research Runtime And Eval Flywheel Roadmap](./delivered_integrated_research_runtime_eval_flywheel_roadmap.md) | Delivered | All phases delivered | 2026-05-20 | Pause automation and run independent deep review of the delivered branch. | None |
| [Framework Simplification Strategy](./not_started_framework_simplification_strategy.md) | Not Started | Phase 0 - Contract freeze and first safe seams | 2026-05-22 | Decide when to start the low-risk CLI runner extraction slice. | Human approval to begin implementation while another roadmap is active |
| [Codex Plugin Product Roadmap](./not_started_codex_plugin_product_roadmap.md) | Not Started | Phase 0 - Product contract and plugin boundary | 2026-05-21 | Decide the plugin product boundary, canonical source layout, and first-run promise. | None |
| [Interaction Modes And Autonomous Mode Roadmap](./delivered_interaction_modes_autonomous_mode_roadmap.md) | Delivered | Complete | 2026-05-22 | Pause automation and run any independent release-readiness review before public release claims. | None |
| [LLM Operator Remote Gateway Roadmap](./not_started_llm_operator_remote_gateway_roadmap.md) | Not Started | Phase 0 - Gateway safety contract | 2026-05-20 | Decide whether a remote/API command gateway is worth building after Codex skill dogfood. | Human approval to start remote/API gateway design |
