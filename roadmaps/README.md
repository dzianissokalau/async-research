...
| [Integrated Research Runtime And Eval Flywheel Roadmap](./in_progress_integrated_research_runtime_eval_flywheel_roadmap.md) | In Progress | Phase 7 - Hybrid API-first routing | 2026-05-20 | Add API-first route decisions, source preference policy, and browser fallback rules. | None |
