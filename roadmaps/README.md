...
| [Integrated Research Runtime And Eval Flywheel Roadmap](./in_progress_integrated_research_runtime_eval_flywheel_roadmap.md) | In Progress | Phase 2 - Clarifier and research brief rewrite | 2026-05-20 | Add a clarifier/research brief contract, CLI draft/validate/apply dry-run support, prompt guidance, and planner/task creation integration where available. | None |
