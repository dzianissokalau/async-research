...
| [Interaction Modes And Autonomous Mode Roadmap](./in_progress_interaction_modes_autonomous_mode_roadmap.md) | In Progress | Phase 3 - Auto-Decision Audit Trail | 2026-05-22 | Expand auto-decision audit rows with policy, reason, actor, confidence, artifacts, and summary support. | None |
