...
| [LLM Operator Skill Roadmap](./in_progress_llm_operator_skill_roadmap.md) | In Progress | Phase 8 - Cross-provider exports and remote gateway scoping | 2026-05-20 | Add provider portability notes and remote-gateway scoping after Codex dogfood evidence. | None |
