...
| [Interaction Modes And Autonomous Mode Roadmap](./in_progress_interaction_modes_autonomous_mode_roadmap.md) | In Progress | Phase 1 - Workspace Mode Config | 2026-05-22 | Add durable interaction-mode config, validators, starter defaults, CLI visibility, and console snapshot fields. | None |
