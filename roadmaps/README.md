...
| [Framework Simplification Strategy](./in_progress_framework_simplification_strategy.md) | In Progress | Phase 6 - Dependency decision record | 2026-05-25 | Decide Typer, jsonschema, and filelock explicitly while preserving the standard-library posture unless evidence changes. | None |
